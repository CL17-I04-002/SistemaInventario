...
namespace SistemaInventario.Areas.Admin.Controllers
{
    ...
    public class ProductoController : Controller
    {
        ...
        ///Esto nos servira para cargar las imágenes en nuestro directorio
        ...
        {
            ///incluirPropiedades es un paráemtro que viene del repositorio genérico y solo se incluye en clases que incluyen a otros objetos
        ...
        public IActionResult Delete(int id)
        {
            ...
            _unidadTrabajo.Guardar();
            return Json(new { success = true, message = "Producto Exitosamente" });
        }
        #endregion
    }
}